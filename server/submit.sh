#!/bin/bash
scp ./server.jar servisofts@192.168.0.10:/home/servisofts/servicios/compra_venta/entornos/compra_venta/servicios/compra_venta/
...
#scp -r ./font servisofts@192.168.0.10:/home/servisofts/servicios/compra_venta/entornos/compra_venta/servicios/compra_venta/
